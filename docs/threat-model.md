...
Project-specific acceptance focus: Test unauthorized clones, key and identity rotation, per-environment separation, decryption failure, Git rollback, controller outage, plaintext scanning, audit logs, backup/restore, and offboarding.
